...
PlayState.preload = function () {
    ...
    this.game.load.image('background', 'images/tacobackground.jpg');
    ...
    this.game.load.audio('sfx:coin', 'audio/nomsound.wav');
...
PlayState._onHeroVsLava = function (hero, lava) {
...
myAudio = new Audio('audio/BackgroundMusic.wav'); 
...
PlayState._onHeroVsLava = function (hero, lava) {
    if (hero.body.velocity.x > 0) { // kill enemies when hero is falling
     this.game.state.restart(true, false, {level: this.level});

    }

PlayState._onHeroVsEnemy = function (hero, lava) {
    this.game.state.restart();
};
